  ...
  return (
    <div id="experience">
      ...
      <div className="route-container">
        <svg className="route">
          <path id="route-two" stroke="#F9E300" fill="none" d="M -850 315 L 110 315 Q 160 315 160 265 L 160 0 Q 160 -50 210 -50 L 1800 -50 " />
        </svg>
      </div>
      ...
      <div className="route-container">
        <svg className="route">
          <path id="route-three" stroke="#D7373F" fill="none" d="M -1005 38 L 795 38 Q 845 38 845 -12 L 845 -2000 " />
        </svg>
      </div>
      <Train line="three" amount={NUM_TRAINS.three} color="#D7373F" />
      <StationSign
        name="HackNY"
        nameSize={55}
        colors={[
      ...
      <div className="route-container">
        <svg className="route">
          <path id="route-four" stroke="#009A44" fill="none" d="M -1000 -1637 L 90 -1637 Q 140 -1637 140 -1587 L 140 -740 Q 140 -640 240 -540 L 1240 460 " />
        </svg>
      </div>
      <Train line="four" amount={NUM_TRAINS.four} color="#009A44" />
    </div>
  );
}
